...

{
	...
	product.setName("HTC Desire");
	product.setDescription("5 inch display");
...
public void updateProductTestCase(){
	...
	product.setDescription("capacity is 3000mah");
...
public void getProductTestCase(){
	...
	assertEquals("getProductTestCase",product.getName(),"Powerbank");
